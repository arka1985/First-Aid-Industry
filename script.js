...
const firstAidData = {
  en: [
    ...
    { id: 38, icon: '⚖️', title: 'OSHWC Code 2020 & Rule Regulations', do: ['Ensure first aid boxes or cupboards are readily accessible during all working hours', 'Keep one first aid box for every 150 workers ordinarily employed', 'Ensure the first-aid box is in the charge of a trained first aider', 'Maintain the contents of the first aid box as prescribed', 'Provide an ambulance room if employing 500 or more workers', 'Final Guidelines, Forms and Formats will be published whenever Central Rules, State Rules, Regulations, Standards will be finally Notified.'], dont: ["Don't keep the first aid box locked during working hours", "Don't delay access to first aid facilities in an emergency", "Don't appoint untrained personnel in charge of the first-aid box", "Don't let the first aid box supplies expire or deplete without restocking"] },
  ]
};
