...
const firstAidData = {
  en: [
    ...
    { id: 36, icon: '🌀', title: 'VERTIGO/DIZZINESS', do: ['Ask for Help', 'Sit or lie down immediately', 'Focus on fixed point', 'Stay hydrated', 'Seek medical help if persistent', 'If the person becomes unconscious and is not breathing, immediately start CPR and use AED if available'], dont: ["Don't stand up quickly", "Don't drive or operate machinery", "Don't ignore recurring episodes", "Don't close eyes while moving"] }
  ],
  hi: [
    { id: 1, icon: '🚑', title: 'पेट की चोट', do: ['मदद मांगें', 'व्यक्ति को लेटा कर रखें', 'घाव को साफ कपड़े से ढकें', 'आपातकालीन सेवाओं को बुलाएं', 'सांस की निगरानी करें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['खाना या पानी न दें', 'अंगों को वापस न धकेलें', 'धंसी वस्तुओं को न निकालें', 'घाव पर सीधा दबाव न डालें'] },
    { id: 2, icon: '✂️', title: 'अंग विच्छेदन', do: ['मदद मांगें', 'सीधे दबाव से रक्तस्राव नियंत्रित करें', 'कटे अंग को साफ थैले में रखें', 'अंग को ठंडा रखें (जमे नहीं)', 'तुरंत चिकित्सा सहायता लें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['अंग को सीधे बर्फ पर न रखें', 'कटे अंग को न धोएं', 'खुद जोड़ने की कोशिश न करें', 'आपातकालीन कॉल में देरी न करें'] },
    { id: 3, icon: '🏔️', title: 'ऊंचाई की बीमारी', do: ['मदद मांगें', 'तुरंत नीची ऊंचाई पर उतरें', 'आराम करें और पानी पिएं', 'उपलब्ध हो तो ऑक्सीजन दें', 'चिकित्सा सहायता लें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['ऊपर चढ़ना जारी न रखें', 'लक्षणों को नज़रअंदाज़ न करें', 'शराब न दें', 'व्यक्ति को अकेला न छोड़ें'] },
    { id: 4, icon: '🐝', title: 'एनाफिलेक्सिस', do: ['मदद मांगें', 'उपलब्ध हो तो एपिपेन का उपयोग करें', 'तुरंत 112 पर कॉल करें', 'व्यक्ति को सपाट लिटाएं', 'सांस की लगातार निगरानी करें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['मौखिक दवा न दें', 'व्यक्ति को बैठाएं नहीं', 'आपातकालीन कॉल में देरी न करें', 'व्यक्ति को अकेला न छोड़ें'] },
    { id: 5, icon: '🦴', title: 'रीढ़ की हड्डी की चोट', do: ['मदद मांगें', 'व्यक्ति को स्थिर रखें', 'सिर और गर्दन को सहारा दें', 'आपातकालीन सेवाओं को बुलाएं', 'कंबल से ढकें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['व्यक्ति को न हिलाएं', 'रीढ़ को न मोड़ें या न झुकाएं', 'हेलमेट मौजूद हो तो न हटाएं', 'खाना या पीना न दें'] },
    { id: 6, icon: '👂', title: 'कान से खून बहना', do: ['मदद मांगें', 'सिर को खून बहने वाली तरफ झुकाएं', 'स्टेराइल पैड से ढीला ढकें', 'तुरंत चिकित्सा सहायता लें', 'व्यक्ति को शांत रखें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['कान की नली को न रोकें', 'कान के अंदर कुछ न डालें', 'सिर को पीछे न झुकाएं', 'सिर की चोट के संकेतों को नज़रअंदाज़ न करें'] },
    { id: 7, icon: '👃', title: 'नाक से खून बहना', do: ['मदद मांगें', 'सीधे बैठें, आगे झुकें', 'नाक के नरम हिस्से को दबाएं', 'ठंडा सेक लगाएं', 'मुंह से सांस लें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['सिर को पीछे न झुकाएं', 'सपाट न लेटें', 'नाक में रुई न भरें', 'जोर से नाक न छिड़कें'] },
    { id: 8, icon: '🩸', title: 'घाव से खून बहना', do: ['मदद मांगें', 'सीधा दबाव डालें', 'घायल हिस्से को ऊपर उठाएं', 'साफ कपड़ा/पट्टी का उपयोग करें', 'गंभीर हो तो मदद बुलाएं', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['धंसी वस्तुओं को न निकालें', 'अनावश्यक रूप से टूर्निकेट का उपयोग न करें', 'घाव को बार-बार न देखें', 'सीधे बर्फ न लगाएं'] },
    { id: 9, icon: '🔥', title: 'जलन', do: ['मदद मांगें', 'बहते पानी से 10-20 मिनट ठंडा करें', 'साफ कपड़े से ढकें', 'सूजन से पहले गहने हटाएं', 'चिकित्सा सहायता लें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['सीधे बर्फ न लगाएं', 'छाले न फोड़ें', 'तेल/मक्खन/टूथपेस्ट का उपयोग न करें', 'चिपके कपड़े न उतारें'] },
    { id: 10, icon: '🧪', title: 'रासायनिक जलन', do: ['मदद मांगें', '20+ मिनट पानी से धोएं', 'दूषित कपड़े हटाएं', 'ढीला ढकें', 'जहर नियंत्रण को कॉल करें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['रसायन को बेअसर करने की कोशिश न करें', 'मलहम न लगाएं', 'गर्म पानी का उपयोग न करें', 'क्षेत्र को न रगड़ें'] },
    { id: 11, icon: '🫁', title: 'सांस लेने में कठिनाई', do: ['मदद मांगें', 'व्यक्ति को सीधा बैठने में मदद करें', 'तंग कपड़े ढीले करें', 'धीमी सांस लेने के लिए प्रोत्साहित करें', 'गंभीर हो तो आपातकालीन कॉल करें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['व्यक्ति को सपाट न लिटाएं', 'खाना या पीना न दें', 'व्यक्ति को अकेला न छोड़ें', 'बिगड़ते लक्षणों को नज़रअंदाज़ न करें'] },
    { id: 12, icon: '💔', title: 'सीने में दर्द', do: ['मदद मांगें', 'व्यक्ति को आराम करने में मदद करें', 'तंग कपड़े ढीले करें', 'तुरंत 112 पर कॉल करें', 'एलर्जी न हो तो एस्पिरिन दें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['दर्द को नज़रअंदाज़ न करें', 'खाना या पानी न दें', 'शारीरिक गतिविधि की अनुमति न दें', 'आपातकालीन कॉल में देरी न करें'] },
    { id: 13, icon: '🤢', title: 'घुटन', do: ['मदद मांगें', 'खांसने के लिए प्रोत्साहित करें', '5 पीठ पर थपकी दें', 'पेट पर दबाव डालें', 'बेहोश हो तो 112 पर कॉल करें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['सीधे खड़े होने पर पीठ पर थपकी न दें', 'मुंह में आंख बंद करके उंगली न डालें', 'पानी न दें', 'बोल सकते हैं तो न रुकें'] },
    { id: 14, icon: '⚡', title: 'दौरा/मिर्गी', do: ['मदद मांगें', 'चोट से बचाएं', 'दौरे का समय नोट करें', 'दौरे के बाद करवट दिलाएं', 'व्यक्ति के साथ रहें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['हरकतों को रोकें नहीं', 'मुंह में कुछ न डालें', 'दौरे के दौरान पानी न दें', 'व्यक्ति को अकेला न छोड़ें'] },
    { id: 15, icon: '🔪', title: 'कट की चोट', do: ['मदद मांगें', 'पहले हाथ धोएं', 'सीधा दबाव डालें', 'पानी से साफ करें', 'स्टेराइल ड्रेसिंग से ढकें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['गंदे हाथों से घाव न छुएं', 'धंसी वस्तुओं को न निकालें', 'सीधे रुई का उपयोग न करें', 'संक्रमण के संकेतों को नज़रअंदाज़ न करें'] },
    { id: 16, icon: '💓', title: 'सीपीआर', do: ['मदद मांगें', 'पहले 112 पर कॉल करें', 'जोर से और तेज दबाएं (100 से 120/मिनट)', 'पूर्ण छाती रिकॉइल की अनुमति दें', 'मदद आने तक जारी रखें'], dont: ['अनावश्यक रूप से कंप्रेशन न रोकें', 'बहुत धीरे न दबाएं', '10 सेकंड से अधिक न रुकें', 'बहुत जल्दी हार न मानें'] },
    { id: 17, icon: '🔋', title: 'एईडी के साथ सीपीआर', do: ['मदद मांगें', 'एईडी चालू करें', 'आवाज संकेतों का पालन करें', 'सुनिश्चित करें कि कोई रोगी को न छुए', 'झटके के बाद सीपीआर फिर से शुरू करें'], dont: ['विश्लेषण के दौरान रोगी को न छुएं', 'गीली सतह पर उपयोग न करें', 'एईडी के लिए सीपीआर में देरी न करें', 'झटके के बीच पैड न हटाएं'] },
    { id: 18, icon: '💧', title: 'निर्जलीकरण', do: ['मदद मांगें', 'धीरे-धीरे पानी/ओआरएस दें', 'ठंडी जगह पर ले जाएं', 'छाया में आराम करें', 'स्थिति की निगरानी करें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['जल्दी बड़ी मात्रा न दें', 'शराब/कैफीन न दें', 'शारीरिक गतिविधि जारी न रखें', 'गंभीर लक्षणों को नज़रअंदाज़ न करें'] },
    { id: 19, icon: '🐕', title: 'कुत्ते/जानवर का काटना', do: ['मदद मांगें', 'घाव को अच्छी तरह धोएं', 'रक्तस्राव नियंत्रित करें', 'चिकित्सा सहायता लें', 'अधिकारियों को रिपोर्ट करें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['मामूली काटने को नज़रअंदाज़ न करें', 'तंग पट्टी न लगाएं', 'रेबीज परामर्श में देरी न करें', 'जानवर को और उकसाएं नहीं'] },
    { id: 20, icon: '🌊', title: 'डूबना', do: ['मदद मांगें', 'सुरक्षित रूप से पानी से निकालें', 'जरूरत हो तो सीपीआर शुरू करें', 'तुरंत 112 पर कॉल करें', 'गर्म रखें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['बिना प्रशिक्षण के बचाव का प्रयास न करें', 'फेफड़ों से पानी निकालने की कोशिश न करें', 'सीपीआर में देरी न करें', 'व्यक्ति को अकेला न छोड़ें'] },
    { id: 21, icon: '👁️', title: 'आंख की चोट', do: ['मदद मांगें', '15+ मिनट साफ पानी से धोएं', 'धोते समय पलकें खुली रखें', 'साफ पैड से ढकें', 'तुरंत चिकित्सा सहायता लें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['आंख को न रगड़ें', 'रसायनों का उपयोग न करें', 'धंसी वस्तुओं को न निकालें', 'चिकित्सा सहायता में देरी न करें'] },
    { id: 22, icon: '🔌', title: 'बिजली का झटका', do: ['मदद मांगें', 'बिजली का स्रोत बंद करें', 'गैर-प्रवाहकीय सामग्री का उपयोग करें', 'सांस और नाड़ी की जांच करें', 'तुरंत 112 पर कॉल करें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['ऊर्जावान होने पर पीड़ित को न छुएं', 'गीली सामग्री का उपयोग न करें', 'आवश्यक न हो तो न हिलाएं', 'मदद बुलाने में देरी न करें'] },
    { id: 23, icon: '😵', title: 'बेहोशी', do: ['मदद मांगें', 'व्यक्ति को सपाट लिटाएं', 'पैर ऊपर उठाएं', 'तंग कपड़े ढीले करें', 'सांस की जांच करें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['तुरंत खाना/पानी न दें', 'व्यक्ति को थप्पड़ या हिलाएं नहीं', 'व्यक्ति को जल्दी बैठाएं नहीं', 'बार-बार होने पर नज़रअंदाज़ न करें'] },
    { id: 24, icon: '🌡️', title: 'बुखार', do: ['मदद मांगें', 'तरल पदार्थ दें', 'ठंडा सेक लगाएं', 'ठंडे कमरे में आराम करें', 'तापमान की निगरानी करें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['कंबल में न लपेटें', 'बच्चों को एस्पिरिन न दें', 'तेज बुखार को नज़रअंदाज़ न करें', 'अल्कोहल रब का उपयोग न करें'] },
    { id: 25, icon: '❄️', title: 'शीतदंश', do: ['मदद मांगें', 'गर्म क्षेत्र में ले जाएं', 'शरीर की गर्मी से धीरे-धीरे गर्म करें', 'प्रभावित क्षेत्र की रक्षा करें', 'चिकित्सा सहायता लें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['क्षेत्र को न रगड़ें', 'सीधी गर्मी का उपयोग न करें', 'ब्लिस्टर न फोड़ें', 'शीतदंश वाले पैरों पर न चलें'] },
    { id: 26, icon: '🤕', title: 'सिर की चोट', do: ['मदद मांगें', 'व्यक्ति को स्थिर रखें', 'आइस पैक लगाएं', 'चेतना की निगरानी करें', 'गंभीर हो तो 112 पर कॉल करें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['व्यक्ति को अनावश्यक रूप से न हिलाएं', 'दवाएं न दें', 'तुरंत सोने की अनुमति न दें', 'बिगड़ते लक्षणों को नज़रअंदाज़ न करें'] },
    { id: 27, icon: '☀️', title: 'लू लगना', do: ['मदद मांगें', 'ठंडी जगह पर ले जाएं', 'अतिरिक्त कपड़े हटाएं', 'शरीर को तेजी से ठंडा करें', '112 पर कॉल करें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['शराब न दें', 'दवाएं न दें', 'व्यक्ति को अकेला न छोड़ें'] },
    { id: 28, icon: '🍬', title: 'हाइपोग्लाइसीमिया', do: ['मदद मांगें', 'होश में हो तो चीनी/जूस दें', '15 मिनट बाद फिर जांचें', 'बाद में जटिल कार्ब्स दें', 'बारीकी से निगरानी करें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['इंसुलिन न दें', 'बेहोश हो तो खाना न दें', 'लक्षणों को नज़रअंदाज़ न करें', 'व्यक्ति को अकेला न छोड़ें'] },
    { id: 29, icon: '☠️', title: 'जहर', do: ['मदद मांगें', 'जहर नियंत्रण को कॉल करें', 'कंटेनर/पदार्थ रखें', 'विशेषज्ञ निर्देशों का पालन करें', 'सांस की निगरानी करें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['उल्टी न कराएं', 'बेअसर करने वाले एजेंट न दें', 'लक्षण देखने के लिए प्रतीक्षा न करें', 'सलाह के बिना सक्रिय चारकोल न दें'] },
    { id: 30, icon: '🐍', title: 'सांप का काटना', do: ['मदद मांगें', 'शांत और स्थिर रहें', 'गहने/तंग वस्तुएं हटाएं', 'सूजन की प्रगति चिह्नित करें', 'तुरंत अस्पताल जाएं', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['टूर्निकेट न लगाएं', 'घाव न काटें', 'जहर न चूसें', 'बर्फ न लगाएं'] },
    { id: 31, icon: '🧠', title: 'स्ट्रोक', do: ['मदद मांगें', 'लक्षणों का समय नोट करें', 'तुरंत 112 पर कॉल करें', 'व्यक्ति को आरामदायक रखें', 'सांस की निगरानी करें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['खाना या पीना न दें', 'दवाएं न दें', 'आपातकालीन कॉल में देरी न करें', 'व्यक्ति को अकेला न छोड़ें'] },
    { id: 32, icon: '☣️', title: 'विषाक्त रासायनिक संपर्क', do: ['मदद मांगें', 'संपर्क से हटाएं', 'दूषित कपड़े हटाएं', '20+ मिनट त्वचा को पानी से धोएं', 'जहर नियंत्रण को कॉल करें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['बेअसर करने वाले एजेंट का उपयोग न करें', 'क्षेत्र को न रगड़ें', 'मलहम न लगाएं', 'विसंदूषण में देरी न करें'] },
    { id: 33, icon: '🌫️', title: 'विषैली गैस साँस लेना', do: ['मदद मांगें', 'ताजी हवा में ले जाएं', 'तंग कपड़े ढीले करें', 'सांस की निगरानी करें', '112 पर कॉल करें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['बिना सुरक्षा के दूषित क्षेत्र में प्रवेश न करें', 'मुंह से कुछ न दें', 'निकासी में देरी न करें', 'हल्के लक्षणों को नज़रअंदाज़ न करें'] },
    { id: 34, icon: '🦵', title: 'जोड़ों/हड्डी में आघात', do: ['मदद मांगें', 'क्षेत्र को स्थिर करें', 'आइस पैक लगाएं', 'संभव हो तो ऊपर उठाएं', 'चिकित्सा सहायता लें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['हड्डियों को फिर से संरेखित करने की कोशिश न करें', 'शुरू में गर्मी न लगाएं', 'घायल हिस्से को न हिलाएं', 'गंभीर दर्द को नज़रअंदाज़ न करें'] },
    { id: 35, icon: '🐜', title: 'कीड़े का काटना/डंक', do: ['मदद मांगें', 'मौजूद हो तो डंक हटाएं', 'साबुन और पानी से धोएं', 'ठंडा सेक लगाएं', 'एलर्जी प्रतिक्रिया देखें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['डंक को न निचोड़ें', 'गर्मी न लगाएं', 'क्षेत्र को न खुजलाएं', 'सूजन को नज़रअंदाज़ न करें'] },
    { id: 36, icon: '🌀', title: 'चक्कर आना', do: ['मदद मांगें', 'तुरंत बैठें या लेटें', 'स्थिर बिंदु पर ध्यान केंद्रित करें', 'हाइड्रेटेड रहें', 'लगातार हो तो चिकित्सा सहायता लें', 'यदि व्यक्ति बेहोश हो जाता है और सांस नहीं ले रहा है, तो तुरंत CPR शुरू करें और यदि उपलब्ध हो तो AED का उपयोग करें'], dont: ['जल्दी न खड़े हों', 'गाड़ी या मशीनरी न चलाएं', 'बार-बार होने वाले एपिसोड को नज़रअंदाज़ न करें', 'चलते समय आंखें बंद न करें'] }
  ]
};
  ...
  data.forEach((item, index) => {
    ...
    card.innerHTML = `
      ...
      <div class="do-section">
        <h3>${currentLang === 'en' ? 'Do' : 'क्या करें'}</h3>
        <ul>${item.do.map(point => `<li>${point}</li>`).join('')}</ul>
      </div>
      <div class="dont-section">
        <h3 class="dont">${currentLang === 'en' ? "Don't" : 'क्या न करें'}</h3>
...
function speakCard(cardId) {
  ...
  // 2. Do Section
  const doText = (currentLang === 'en' ? 'Do: ' : 'क्या करें: ') + item.do.join('. ');
  ...
  // 3. Don't Section
  const dontText = (currentLang === 'en' ? 'Don\'t: ' : 'क्या न करें: ') + item.dont.join('. ');
