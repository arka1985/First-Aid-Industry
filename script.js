...
const firstAidData = {
  en: [
    ...
    { id: 16, title: 'CPR', do: ['Ask for Help', 'Call 112 first', 'Push hard and fast (100 to 120/min)', 'Allow full chest recoil', 'Continue until help arrives'], dont: ["Don't stop compressions unnecessarily", "Don't compress too slowly", "Don't interrupt for more than 10 sec", "Don't give up too early"] },
  ...
  hi: [
    ...
    { id: 16, title: 'सीपीआर', do: ['मदद मांगें', 'पहले 112 पर कॉल करें', 'जोर से और तेज दबाएं (100 से 120/मिनट)', 'पूर्ण छाती रिकॉइल की अनुमति दें', 'मदद आने तक जारी रखें'], dont: ['अनावश्यक रूप से कंप्रेशन न रोकें', 'बहुत धीरे न दबाएं', '10 सेकंड से अधिक न रुकें', 'बहुत जल्दी हार न मानें'] },
